...
public class SplitJDialog extends javax.swing.JDialog {
    ...
    public SplitJDialog(Vector<ClientOrder> clientOrders, Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        tbOrders.setModel(new DefaultTableModel(
            new Object [][] {
            ...
            Class[] types = new Class [] {
                Object.class, Object.class, Object.class, Double.class, Integer.class
            };
