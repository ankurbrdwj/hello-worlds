...
public class TradeJFrame extends javax.swing.JFrame implements ExecutionListener {
    ...
    private void initComponents() {
        ...
        jSplitPane1.setPreferredSize(new Dimension(883, 500));

        jPanel1.setLayout(new java.awt.BorderLayout());

        jPanel2.setPreferredSize(new Dimension(797, 24));
        ...
        jPanel4.setPreferredSize(new Dimension(881, 24));
        ...
        tbExecutions.setModel(new DefaultTableModel(
            new Object [][] {
        ...
        jPanel5.setPreferredSize(new Dimension(10, 20));
        ...
        lstFixTags.setModel(new DefaultTableModel(
            new Object [][] {
                {"6061", "0"},
                {"109", "HSBC"},
                {null, null},
